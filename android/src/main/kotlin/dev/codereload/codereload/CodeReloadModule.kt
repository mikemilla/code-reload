...
class CodeReloadModule(reactContext: ReactApplicationContext) :
    ReactContextBaseJavaModule(reactContext) {

    override fun getName() = "CodeReloadModule"

    private var fabView: CodeReloadFABView? = null
    private var sheetFragment: CodeReloadSheetFragment? = null
    ...
    fun showSheet() {
        ...
        fragmentActivity.runOnUiThread {
            val fragment = CodeReloadSheetFragment(
                messages = messages,
            ...
            fragment.show(fragmentActivity.supportFragmentManager, "codereload_sheet")
